...
var CesiumComponent = /** @class */ (function () {
    function CesiumComponent(el) {
        this.el = el;
    }
    ...
    CesiumComponent.prototype.initCamera = function () {
    ...
    CesiumComponent.prototype.pedestrianView = function () {
        var defaultHeight;
        var defaultPitch;
    ...
    CesiumComponent.prototype.helicopterView = function () {
        //	alert("HE");
